"""
Django settings for tuning_buddy project.
...
DEBUG = os.environ.get('DEBUG', 'True').lower() == 'true'  # TEMP DEBUG
...
WHITENOISE_USE_FINDERS = True  # Help find files on Vercel if collectstatic misses them
